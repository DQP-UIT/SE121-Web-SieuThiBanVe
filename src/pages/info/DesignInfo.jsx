...
const DesignInfo = () => {
  ...
  if (!product) {
    return (
      <div className="flex h-[80vh] mt-12 w-full flex-auto justify-center text-2xl text-blue-300 mix-blend-overlay">
  ...
  return (
    <div>
      ...
      <div className="ml-8 mt-6">
        ...
        <div className="mt-4 pr-40 font-sans text-xl text-white">
          {product.description}
        </div>
      </div>
      <div className="ml-8 mt-6">
