      ...
      <Paper elevation={3} sx={{ p: 4 }}>
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            ...
            <Alert severity="info">
              Hướng dẫn: Số tầng là chưa bao gồm tum mái. Trường hợp nhà 3 tầng,
              không tum mái, nhưng tầng 3 muốn lợp tôn toàn bộ thì nhập "số tầng
              là 02 tầng, diện tích tum mái bằng diện tích tầng 2"
            </Alert>
